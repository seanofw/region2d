...
var Region2D = function () {
		...
		if (array.length === 1) {
			...
			for (var rowIndex = 1, numRows = array.length; rowIndex < numRows; rowIndex++) {
				...
				for (var _i2 = 0; _i2 < _spans.length; _i2 += 2) {
					edges.push({ x1: _spans[_i2 + 1], y1: _y, x2: _spans[_i2], y2: _y, kind: "bottom",
						key1: null, key2: null, next: null, prev: null, used: false });
				}
				...
				_spans = array[0].region.getRawSpans();
				for (var _i4 = 0; _i4 < _spans.length; _i4 += 2) {
					edges.push({ x1: _spans[_i4 + 1], y1: _y, x2: _spans[_i4 + 1], y2: _y2, kind: "right",
						key1: null, key2: null, next: null, prev: null, used: false });
					edges.push({ x1: _spans[_i4], y1: _y2, x2: _spans[_i4], y2: _y, kind: "left",
						key1: null, key2: null, next: null, prev: null, used: false });
				}
			}
			...
			for (var _i5 = 0; _i5 < _spans.length; _i5 += 2) {
				edges.push({ x1: _spans[_i5 + 1], y1: _y2, x2: _spans[_i5], y2: _y2, kind: "bottom",
					key1: null, key2: null, next: null, prev: null, used: false });
			}
		}
	},
  ...
  */
	makeEdgeTable = function makeEdgeTable(edges) {
		...
		for (var i = 0, l = edges.length; i < l; i++) {
			...
			if (!edge.key1 in table) table[key1] = [edge];else table[key1].push(edge);
		}
  ...
  */
	makeWindings = function makeWindings(edges, table) {
		...
		var findBestPossibleEdge = function findBestPossibleEdge(edge, possibleEdges) {
			...
			for (var _i6 = 0, _l = possibleEdges.length; _i6 < _l; _i6++) {
				if (possibleEdges[_i6].used) continue;
				return possibleEdges[_i6];
			}
  ...
  *     ]
  */
	getPath = function getPath(array) {
