...
var Region1D = function () {
  ...
  */
	doesIntersectData = function doesIntersectData(array1, array2) {
		...
		var result = false;
		combineData(array1, array2, function (depth1, lastDepth1, depth2, lastDepth2) {
			if ((depth1 | depth2) !== (lastDepth1 | lastDepth2)) result = true;
			return false;
		});
		return result;
	},
  ...
  */
	doesDataMatch = function doesDataMatch(array1, array2) {
		if (array1.length != array2.length) return false;
  ...
  */
	makeRects = function makeRects(array, y, height) {
		var result = [];
  ...
  */
	makeChecksum = function makeChecksum(array) {
		var checksum = 0;
  ...
  */
	Region1D = function Region1D(array, key, checksum) {
		...
		if (key === privateKey) {
			...
			if (typeof checksum !== 'number') checksum = makeChecksum(array);
  ...
  */
	var getData = function getData(region) {
  ...
  */
	Region1D.prototype = {
		...
		getRects: function getRects(y, height) {
			var data = getData(this);
...
//# sourceMappingURL=region1d.js.map